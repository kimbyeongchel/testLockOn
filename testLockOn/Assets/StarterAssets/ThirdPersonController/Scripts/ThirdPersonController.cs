...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        LockOnTarget lockOn;
        [SerializeField] float cameraDirectionY;
        [SerializeField] float cameraSmoothing = 50;
        ...
        private void CameraRotation()
        {
            ...
            {
                Vector3 direction = (lockOn.currentTarget.transform.position - CinemachineCameraTarget.transform.position).normalized;
